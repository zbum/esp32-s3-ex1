...
func (d Device) WriteByte(c byte) error {
	...
	case 80e6: // 80MHz
		...
		return nil
	case 240e6: // 240MHz
		// NOP counts scaled 1.5x from the 160MHz block so the actual ns
		// timings (T0H/T0L/T1H/T1L) match the proven 160MHz case.
		// T0H: 60  cycles or  250.0ns
		// T0L: 197 cycles or  820.8ns
		//   +: 257 cycles or 1070.8ns
		// T1H: 143 cycles or  595.8ns
		// T1L: 113 cycles or  470.8ns
		//   +: 256 cycles or 1066.7ns
		device.AsmFull(`
		1: // send_bit
			s32i  {maskSet}, {portSet}, 0     // [1]  T0H and T1H start here
			nop                               // [56]
