...
ESP32-S3-N8R2 / N16R8 (44핀 USB-C DevKit, 8MB PSRAM) + TinyGo 예제 프로젝트. 현재 동작 모드: ST7789V3 콘솔 + SGP40(VOC) + AHT10(온/습도) 1Hz 측정, WiFi 빌드 시 Prometheus Pushgateway 로 세 메트릭 동시 push.
